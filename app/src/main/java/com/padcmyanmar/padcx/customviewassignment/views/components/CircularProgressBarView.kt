...
class CircularProgressBarView @JvmOverloads constructor(
    ...
    private fun setUpAttributes(attrs: AttributeSet?){
        context.withStyledAttributes(attrs, R.styleable.CircularProgressBarView){
            mProgressColor=getColor(R.styleable.CircularProgressBarView_setProgressColor,Color.RED)
            mStrokeWidth=getInt(R.styleable.CircularProgressBarView_setProgressWidth,8)
            mTextColor=getColor(R.styleable.CircularProgressBarView_setProgressColor,Color.RED)
            mDrawText=getBoolean(R.styleable.CircularProgressBarView_showProgressText,true)
        }
        invalidate()
    }
